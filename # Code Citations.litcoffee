...
### **2️⃣ Créer `lib/types.ts`** (NOUVEAU FICHIER)

```typescript
// ================================================================
// Type Definitions — VitrinePro
// ================================================================
...
### **3️⃣ Créer `lib/animations.ts`** (NOUVEAU FICHIER)
...
### **4️⃣ Mettre à jour `package.json`**

Recherchez la section `"dependencies"` et remplacez-la par :
...
### **5️⃣ Remplacer `app/globals.css`** (COMPLET)

```css
/* ================================================================
   VITRINEPRO — Global Styles & Design System v2
   ================================================================ */

@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,600;0,700&family=DM+Sans:wght@300;400;500;600;700&display=swap');
...
body::before {
  ...
  position: fixed;
  inset: 0;
  background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' opacity='0.02'/%3E%3C/svg%3E");
  pointer-events: none;
  z-index: 9999
```
